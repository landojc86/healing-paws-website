  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* About Healing Paws Center Section */}
        <div className="text-center mb-16">
          <h2 className="text-gray-900 mb-6">About Healing Paws Center</h2>
        ...
        {/* Original Why Choose Us Features */}
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-[#b7e1da]/30 rounded-2xl p-8 space-y-6">
            <h3 className="text-gray-900">Why Choose Us</h3>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-[#b48cbf] rounded-full mt-2 flex-shrink-0" />
                <span className="text-gray-700">State-of-the-art holistic care equipment and facilities</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-[#b48cbf] rounded-full mt-2 flex-shrink-0" />
                <span className="text-gray-700">Evidence-based treatment protocols backed by research</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-[#b48cbf] rounded-full mt-2 flex-shrink-0" />
                <span className="text-gray-700">Comprehensive post-treatment care and home exercise programs</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-[#b48cbf] rounded-full mt-2 flex-shrink-0" />
                <span className="text-gray-700">Collaboration with your veterinarian for integrated care</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-[#b48cbf] rounded-full mt-2 flex-shrink-0" />
                <span className="text-gray-700">Proven track record of successful wellness outcomes</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-[#b48cbf] rounded-full mt-2 flex-shrink-0" />
                <span className="text-gray-700">Flexible scheduling and convenient location in Florida</span>
              </li>
            </ul>
          </div>
        </div>
