    ...
    <section id="blog" className="py-12 sm:py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 sm:mb-16">
          <h1 className="text-gray-900 mb-4 sm:mb-6 text-2xl sm:text-3xl">Holistic Resources & Insights</h1>
          <p className="text-gray-600 max-w-3xl mx-auto text-lg">
            Tips to help you understand Holistic Medicine for your pet
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg overflow-hidden shadow-lg mb-12">
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="p-6 sm:p-8 flex flex-col justify-center">
              ...
              <h3 className="text-gray-900 mb-4 text-xl sm:text-2xl">{blogPosts[0].title}</h3>
              <p className="text-gray-600 text-lg mb-4 leading-relaxed">{blogPosts[0].excerpt}</p>
              <div className="flex items-center gap-4 mb-4 text-gray-600 text-lg">
          ...
          {blogPosts.slice(1, 7).map((post, index) => (
            <div key={index} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow">
              ...
              <div className="p-5">
                ...
                <h4 className="text-gray-900 mb-3 line-clamp-2 text-lg sm:text-xl">{post.title}</h4>
                <p className="text-gray-600 text-lg mb-4 line-clamp-3 leading-relaxed">{post.excerpt}</p>

                <div className="flex items-center gap-2 mb-4 text-gray-600 text-lg border-t pt-3">
                  <div className="flex items-center">
                    <User className="w-4 h-4 mr-1" />
        ...
        <div className="text-center mb-12">
          <Link
            to="/blog"
            className="inline-block bg-[#b48cbf] text-white px-8 py-4 rounded-lg hover:bg-[#9d6fa8] transition-colors font-semibold text-lg"
          >
            View More
          </Link>
        </div>
      ...
      <div className="bg-gradient-to-r from-[#b7e1da] to-[#b48cbf] py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-white mb-4 sm:mb-6 text-2xl sm:text-3xl">Stay Updated with Expert Pet Care Tips</h2>
          <p className="text-white mb-6 sm:mb-8 max-w-2xl mx-auto opacity-90 text-lg leading-relaxed">
          ...
          <div className="max-w-md mx-auto flex flex-col sm:flex-row gap-3">
            <input
              ...
              className="flex-1 px-4 sm:px-6 py-3 sm:py-4 rounded-lg text-lg text-gray-900 bg-white border-2 border-white focus:outline-none focus:ring-2 focus:ring-white focus:border-transparent shadow-lg placeholder:text-gray-500"
            />
            <button className="bg-white text-[#b48cbf] px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-gray-100 transition-colors whitespace-nowrap font-semibold shadow-lg text-lg">
              Subscribe Now
            </button>
          </div>
          <p className="text-white text-lg mt-3 sm:mt-4 opacity-75">
